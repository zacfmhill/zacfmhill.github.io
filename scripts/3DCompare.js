    ...
    if (file) {
        ...
        loader.load(
            ...
            function (object) {            // called when resource is loaded
                var mesh = new THREE.Mesh(object, new THREE.MeshBasicMaterial({
                    color: 0xff00ff
                  }));
            ...
            console.log("stl volume is " + volumeCalculated);
            volumeModalText.innerHTML = "STL volume is " + volumeCalculated;
            volumeModal.show();
            },
